...
flags.DEFINE_string('experiment', 'automl_lr0.1', 'Name of the current experiment')
...
flags.DEFINE_string('summary_dir', './automl_pg/summaries', 'Directory for storing tensorboard summaries')
flags.DEFINE_string('checkpoint_dir', './automl_pg/checkpoints', 'Directory for storing model checkpoints')
...
flags.DEFINE_string('checkpoint_path', './automl_pg/checkpoints/automl_pg.ckpt-100', 'Path to recent checkpoint to use for evaluation')
flags.DEFINE_string('eval_dir', './automl_pg/', 'Directory to store gym evaluation')
